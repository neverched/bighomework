    ...
    <div class="side-container">
      <div class="box-card fans-view">
        <div class="box-card-son">
          <div @click="handleClickFans" class="box-card-son-data can-click">{{ boxData.fans }}</div>
          <div class="box-card-son-title">粉丝</div>
        </div>
        <div class="box-card-son">
          <div @click="handleClickFollowing" class="box-card-son-data can-click">{{ boxData.follows }}</div>
      ...
      <div v-show="recentWrites.length" class="box-card write-box">
        ...
        <div v-for="item in recentWrites" :key="item.id" class="item" @click="handleItemClick(item)">{{ item.content }}</div>
      </div>
    </div>
  </div>
</template>

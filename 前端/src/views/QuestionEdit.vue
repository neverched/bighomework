<template>
  <el-row>
    <el-col :offset="2" :span="18">
      ...
      <br>
      <br>
      <el-input v-model="textarea1" placeholder="标题（必填）" />
      <div style="margin: 20px 0"></div>
      <br>
      <br>
      <el-input v-model="textarea2" :autosize="{ minRows: 2, maxRows: 4 }" type="textarea" placeholder="题干（必填）" />
      <div style="margin: 20px 0"></div>
      <br>
      <br>
      <el-input v-model="textarea3" :autosize="{ minRows: 2, maxRows: 4 }" type="textarea" placeholder="答案（必填）" />
    </el-col>
...
const save = function () {
  ...
  api.post('spaces/1/exercises/new', formData).then(
    res => {
      console.log(res)
